...
describe Russian do
  describe "transliteration" do
    ...
    it "should properly transliterate mixed russian-english strings" do
      expect(t("Это кусок строки русских букв v peremeshku s latinizey i амперсандом (pozor!) & something")).to eq "Eto kusok stroki russkih bukv v peremeshku s latinizey i ampersandom (pozor!) & something"
    end
